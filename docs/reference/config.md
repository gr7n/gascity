...
| `startup_timeout` | string |  | `180s` | StartupTimeout is how long to wait for each agent's Start() call before treating it as failed. Duration string (e.g., "60s", "3m"). Defaults to "180s". |
