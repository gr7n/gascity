...
func TestDashboardBindListenAddrUsesExplicitBind(t *testing.T) {
	if got := dashboardBindListenAddr("0.0.0.0", 8080); got != "0.0.0.0:8080" {
		t.Fatalf("dashboardBindListenAddr() = %q, want 0.0.0.0:8080", got)
	}
}
