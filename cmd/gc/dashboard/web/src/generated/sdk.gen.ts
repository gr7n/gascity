 ...
 */
export const getV0CityByCityNameRequestById = <ThrowOnError extends boolean = false>(options: Options<GetV0CityByCityNameRequestByIdData, ThrowOnError>) => (options.client ?? client).get<GetV0CityByCityNameRequestByIdResponses, GetV0CityByCityNameRequestByIdErrors, ThrowOnError>({ url: '/v0/city/{cityName}/request/{id}', ...options });
 ...
 */
export const getV0RequestById = <ThrowOnError extends boolean = false>(options: Options<GetV0RequestByIdData, ThrowOnError>) => (options.client ?? client).get<GetV0RequestByIdResponses, GetV0RequestByIdErrors, ThrowOnError>({ url: '/v0/request/{id}', ...options });
