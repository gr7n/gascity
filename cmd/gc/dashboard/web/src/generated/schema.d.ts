...
export interface components {
    schemas: {
        ...
        RequestFailedPayload: {
            /**
             * Format: int64
             * @description Elapsed milliseconds since the async request was accepted, if known.
             */
            elapsed_ms?: number;
            ...
            request_id: string;
            /**
             * @description Async stage active when the failure was emitted, if known.
             * @enum {string}
             */
        ...
        RequestProgressPayload: {
            /**
             * Format: int64
             * @description Elapsed milliseconds since the async request was accepted.
             */
            elapsed_ms: number;
            /**
             * @description Async operation reporting progress.
             * @enum {string}
             */
            operation: "city.create" | "city.unregister" | "session.create" | "session.message" | "session.submit";
            /** @description Correlation ID from the 202 response. */
            request_id: string;
            /** @description Resolved session ID once known. */
            session_id?: string;
            /** @description Original session target from the request, when applicable. */
            session_target?: string;
            /**
             * @description Current async request stage.
             * @enum {string}
             */
            stage: "resolving" | "materializing" | "delivering" | "submitted" | "timeout";
        };
        RequestStatus: {
             ...
             */
            operation?: "city.create" | "city.unregister" | "session.create" | "session.message" | "session.submit";
            /** @description Latest non-terminal progress event for this request, if one was observed. */
            progress?: components["schemas"]["TypedEventStreamEnvelope"];
            /** @description Async request ID. */
            request_id: string;
            /**
             * @description Latest async request progress stage, if known.
             * @enum {string}
             */
            stage?: "resolving" | "materializing" | "delivering" | "submitted" | "timeout";
            /**
        ...
        SupervisorRequestStatus: {
             ...
             */
            operation?: "city.create" | "city.unregister" | "session.create" | "session.message" | "session.submit";
            /** @description Latest non-terminal tagged progress event for this request, if one was observed. */
            progress?: components["schemas"]["TypedTaggedEventStreamEnvelope"];
            /** @description Async request ID. */
            request_id: string;
            /**
             * @description Latest async request progress stage, if known.
        ...
        TypedEventStreamEnvelopeRequestProgress: {
            actor: string;
            message?: string;
            payload: components["schemas"]["RequestProgressPayload"];
            /** Format: int64 */
            seq: number;
            subject?: string;
            /** Format: date-time */
